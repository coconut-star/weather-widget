function setTransform3D (el, degree, perspective, z) {
  ...
  function displayIndex (imgSize, spacing, left, imgs, index, flat, width, titleBox, vnode) {
    ...
    if (vnode.context.forecastList[index].title) {
      titleBox.style.visibility = 'visible'
      var info = vnode.context.forecastList[index].title
  ...
  export default {
    bind: function (el, binding, vnode) {
      ...
      if (shadow) {
        el.style.height = (imgHeight * 2 + 180) + 'px'
        ...
        el.style.height = (imgHeight + 180) + 'px'
      }
